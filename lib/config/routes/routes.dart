...
import '../../features/trending_jobs/view/trending_jobs_view.dart';
import '../../features/trending_jobs/view/job_search_view.dart';
import '../../features/trending_jobs/view/job_market_detail_view.dart';
...
class AppRoutes {
  static List<GetPage> routes = [
    ...
    GetPage(name: RouteNames.login, page: () => const SignInView()),

    GetPage(name: RouteNames.register, page: () => const SignUpView()),
    ...
    GetPage(name: RouteNames.navBar, page: () => const NavView()),

    GetPage(name: RouteNames.mockInterview, page: () => const MockInterview()),
    ...
    GetPage(
      ...
      page: () {
        ...
        return InterviewLevels(name: name, icon: icon);
      },
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        return InterviewScreen(category: category, level: level);
      },
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        return ResultScreen(category: category, level: level, result: result);
      },
    ),
    ...
    GetPage(name: RouteNames.connections, page: () => const ConnectionsView()),
    GetPage(name: RouteNames.userProfile, page: () => const UserProfileView()),
    GetPage(
      name: RouteNames.notifications,
      page: () => const NotificationsView(),
    ),
    GetPage(name: RouteNames.editJob, page: () => const EditJobView()),
    GetPage(name: RouteNames.editEvent, page: () => const EditEventView()),
    GetPage(
    ...
    // Trending Jobs
    GetPage(
      name: RouteNames.trendingJobs,
      page: () => const TrendingJobsView(),
      binding: BindingsBuilder(() {
        if (!Get.isRegistered<TrendingJobsController>()) {
          Get.put(TrendingJobsController(Get.find()));
        }
      }),
    ),
    GetPage(name: RouteNames.jobSearch, page: () => const JobSearchView()),
    GetPage(
      name: RouteNames.jobMarketDetail,
      page: () => const JobMarketDetailView(),
    ),
  ];
}
